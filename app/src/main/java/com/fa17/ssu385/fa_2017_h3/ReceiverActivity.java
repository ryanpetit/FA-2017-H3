...
public class ReceiverActivity extends AppCompatActivity {
    ...
    public static final String SENDER_NAME_KEY = "";
    public static final String SENDER_MESSAGE_KEY = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().add(R.id.receiver_frame, receiveMessageFragment).commit();
    }
}
