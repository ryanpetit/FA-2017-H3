...
public class SenderActivity extends AppCompatActivity implements SendMessageFragment.OnSendButtonClick {
    private SendMessageFragment theMessageFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        theMessageFragment = new SendMessageFragment();
        getSupportFragmentManager().beginTransaction().add(R.id.asFrameLayout1, theMessageFragment).commit();
    }
